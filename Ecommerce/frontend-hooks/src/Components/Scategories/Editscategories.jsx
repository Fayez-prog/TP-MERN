...
const Editscategorie = ({ show, handleClose, scategorie: initialData }) => {
  const [scategorie, setScategorie] = useState(initialData);
  const [categories, setCategories] = useState([]);
  const [files, setFiles] = useState(
    initialData.imagescategorie ? [{ source: initialData.imagescategorie }] : []
  );
  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg">
      <Modal.Header closeButton>
        <Modal.Title>Modifier Sous-Catégorie</Modal.Title>
      </Modal.Header>
